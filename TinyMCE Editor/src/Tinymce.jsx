...
class Tinymce extends React.Component {
  ...
  handleEditorChange = (e) => {
    ...
    //  console.log(e.target.setContent("<h1>Hello</h1>"));
    // var ed = e.target.getContent({format: 'text'});
    // ed.setContent("<h1>Hello</h1>");
  }

  handleEditor = () => {
    // console.log('contentdidmount', window.tinymce.get('editor1'));
    var ed =window.tinymce.get('editor1');
    ed.setContent("<h1>Hello</h1>");
    // var inst, contents = new Object();
    // for (inst in tinymce.editors) {  className='note-template-content' id="editor1"
    //     if (tinyMymce.editors[inst].getContent) .setContent("<h1>Hello</h1>")
    //         contents[inst] = tinyMymce.editors[inst].getContent();
    // }
    // this.abc = "<p>This is the initial content of the editor</p>";
    // console.log(this.noteTemplateContent.render());
  }
...
// }
  ...
  render() {
    // const abc = "<p>This is the initial content of the editor</p>";
    ...
    return (
      <div> <h1>tinymce</h1>
        <Editor 
            ...
            className='note-template-content' id="editor1"
            bounds={'.editor-bound'}
            ...
            <button value="click" onClick={this.handleEditor}/>
      </div>
    );
  }
}
